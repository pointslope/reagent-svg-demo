...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4170__auto__,writer__4171__auto__,opt__4172__auto__){
return cljs.core._write(writer__4171__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_25318 = (0);
while(true){
if((i_25318 < arr.length)){
(arr[i_25318] = null);

var G__25319 = (i_25318 + (1));
i_25318 = G__25319;
continue;
} else {
}
...
var i_25331 = (self__.level + (1));
while(true){
if((i_25331 <= (new_level + (1)))){
(update[i_25331] = self__.header);

var G__25332 = (i_25331 + (1));
i_25331 = G__25332;
continue;
} else {
}
...
var i_25333 = (0);
while(true){
if((i_25333 <= self__.level)){
var links_25334 = (update[i_25333]).forward;
if(((links_25334[i_25333]) === x__$1)){
(links_25334[i_25333] = (x__$1.forward[i_25333]));

var G__25335 = (i_25333 + (1));
i_25333 = G__25335;
continue;
} else {
var G__25336 = (i_25333 + (1));
i_25333 = G__25336;
continue;
}
} else {
...
if(!((nx == null))){
var G__25338 = nx;
var G__25339 = (level__$1 - (1));
x = G__25338;
level__$1 = G__25339;
continue;
} else {
var G__25340 = x;
var G__25341 = (level__$1 - (1));
x = G__25340;
level__$1 = G__25341;
continue;
}
...
var G__25343 = nx;
var G__25344 = (level__$1 - (1));
x = G__25343;
level__$1 = G__25344;
continue;
} else {
var G__25345 = x;
var G__25346 = (level__$1 - (1));
x = G__25345;
level__$1 = G__25346;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4170__auto__,writer__4171__auto__,opt__4172__auto__){
return cljs.core._write(writer__4171__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__3583__auto__ = (cljs.core.truth_((function (){var and__3571__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3583__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__3583__auto__,timeout__$1,me))
,msecs);
